...
$(document).ready(function() {
    ...
    $('section').c('body').find('.player').each(function() {
        var section = $(this).closest('section');
        section.find('.container').addClass('fadeOut');
        var src = $(this).attr('data-video-id');
        var startat = $(this).attr('data-start-at');
        $(this).attr('data-property', "{videoURL:'http://youtu.be/" + src + "',containment:'self',autoPlay:true, mute:false, startAt:" + startat + ", opacity:1, showControls:false}");
    });
        ...
        $('.countdown').each(function() {
            ...
            $(this).countdown(date, function(event) {
                $(this).text(
                    ...
                    event.strftime('%D Hari 123 Lagi')
                );
            });
        });
    }
    ...
    // FlipClock Countdown
		...
		if( date > now){
			...
			diff=48767.78999996185;
		}

        var clock = $('.clock').FlipClock(diff, {
        //var clock = $('.clock').FlipClock(23000 * 24 * 3, {
