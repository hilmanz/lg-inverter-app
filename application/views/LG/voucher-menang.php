...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>LG Inverter | #BerbagiEnergi</title>
            ...
            <section class="image-square left">
                <div class="col-md-6 image">
                    <div class="background-image-holder">
                        <img src="<?=base_url()?>assets/img/voucher-banner.jpg" alt="Hemat Energi Bagimu Negeri">
                    </div>
                    <!-- <div class="inner-title title-center text-center">
                        <div class="title pt-sm-104 pt-xs-120">
                ...
                <div class="col-md-6 col-md-offset-1 content text-center-xs">
                    <h3 class="bold"><span class="color-primary">Selamat!</span> <span class="color-black">Anda memenangkan Voucher Sodexo sebesar Rp100rb</span></h3>
                    <h4 class="lead">
                        Terimakasih telah mendaftar ke acara Hemat Energi Bagimu Negeri bersama LG di Car Free day. </h4>
                    <h4 class="lead">
                        Tukarkan hadiah yang kamu dapatkan di acara Car Free Day tanggal <span class="color-primary">20 November 2016</span> dengan menyebutkan nama akun Facebook beserta email yang telah kamu daftarkan.
                    </h4>
                    <a class="btn btn-lg btn-rounded btn-filled" href="<?=base_url()?>">Kembali</a>
                </div>
            </section>
